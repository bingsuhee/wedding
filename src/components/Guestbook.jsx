        ...
        <form onSubmit={handleSubmit} className="mb-8 bg-white p-6 rounded-2xl shadow-sm border border-gray-100 shrink-0">
          ...
          <div className="mb-4">
            <textarea
              ...
              className="w-full h-20 px-4 py-2 rounded-xl border border-gray-100 bg-gray-50/50 focus:outline-none focus:ring-1 focus:ring-wedding-accent/30 text-xs font-serif resize-none"
              value={content}
